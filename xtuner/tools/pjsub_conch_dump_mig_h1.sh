#!/bin/bash
# =============================================================================
# CONCH dump — MIG, HALF 1 of 2  (pjsub_conch_dump_mig_h0.sh + this = full set).
# 8 MIG sub-jobs handle global shards 8..15 of N_SHARDS=16 (the SECOND half).
# pjsub_conch_dump_mig_h0.sh handles shards 0..7 (the FIRST half).
...
# ---- this half (hard-coded; the only difference vs h0) ----
N_SHARDS=16              # global shards across BOTH jobs (8 in h0 + 8 here)
SHARD_OFFSET=8          # h1 -> global shards 8..15 ; h0 sets 0
